...
public class BTree {
	...
	private final String PREFIX_ADDRESS_OF_TREES = "C:\\Users\\Andrew Sidorchuk\\CSC365 Workspace\\Assignment 2 Application\\UserBTrees\\";
	
	public BTree(String name, String [] contents) {

		
		try {
			file = new RandomAccessFile(PREFIX_ADDRESS_OF_TREES + name, "rw");
	...
	public Node allocate_node() {
		...
		File f = new File(PREFIX_ADDRESS_OF_TREES + name);
